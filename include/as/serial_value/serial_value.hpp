...
namespace as {
	...
	public:
		...
		serial_value(uint16_t) throw();
		serial_value(uint32_t) throw();
		serial_value(uint64_t) throw();
		serial_value(int8_t) throw();
		serial_value(int16_t) throw();
		serial_value(int32_t) throw();
		serial_value(int64_t) throw();
		serial_value(float) throw();
		serial_value(double) throw();
		serial_value(pointer_t) throw();
